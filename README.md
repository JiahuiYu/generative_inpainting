...
0. Requirements:
    ...
    * Install tensorflow toolkit editted by my own. [neuralgym](https://github.com/frozenburst/neuralgym) (run `pip install git+https://github.com/frozenburst/neuralgym`).
1. Training:
